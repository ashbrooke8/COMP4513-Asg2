      ...
      <dialog id="details_modal" className="modal">
        <div className="modal-box h-[500px] max-w-[900px]">
          ...
          <div className="flex gap-8">
            ...
            <div>
                <p className="text-gray-700 text-xl font-bold">{props.painting.title} ({props.painting.yearOfWork})</p>
                <p className="text-gray-700">
                {props.painting.artist.firstName} {props.painting.artist.lastName}
              </p>
                {/* <p className="text-gray-700">{props.painting.yearOfWork}</p> */}
                ...
                <p className="text-gray-700">Located at {props.painting.gallery.galleryName} in {props.painting.gallery.galleryCity}</p>
                <p className="text-gray-700">{props.painting.description}</p>
                <p className="text-gray-700">Copyright: {props.painting.copyrightText}</p>
                <a href={props.painting.museumLink} target="_blank" rel="noopener noreferrer" className="text-indigo-500 hover:underline">Museum</a>
                <a href={props.painting.wikiLink} target="_blank" rel="noopener noreferrer" className="text-indigo-500 hover:underline">Wikipedia</a>
            </div>
          </div>
          <button
